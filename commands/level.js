...
module.exports = {
    ...
    async execute(interaction) {
        if (interaction.options.getSubcommand() === "show_level") {
            await show_level.execute(interaction);
        } else if (interaction.options.getSubcommand() === "show_leaderboard") {
            await show_leaderboard.execute(interaction);
        } else if (interaction.options.getSubcommand() === "add_xp") {
